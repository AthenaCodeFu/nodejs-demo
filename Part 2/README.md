...
- [TL;DR](#tldr)
- [Files](#files)
- [History/Architecture Summary](#historyarchitecture-summary)
    - [The Current Situation](#the-current-situation)
    - [Drawbacks](#drawbacks)
    - [Isolating Conversion Work with the Current Methodology](#isolating-conversion-work-with-the-current-methodology)
- [Proposed Changes](#proposed-changes)
    - [Goals](#goals)
    - [Using NodeJS and Captive PhantomJS Instances](#using-nodejs-and-captive-phantomjs-instances)
    - [Limitations of NodeJS](#limitations-of-nodejs)
...
#### Using NodeJS and Captive PhantomJS Instances
